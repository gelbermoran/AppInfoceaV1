...
class DespachosWidget extends StatefulWidget {
  const DespachosWidget({Key key}) : super(key: key);

  @override
  _DespachosWidgetState createState() => _DespachosWidgetState();
}

class _DespachosWidgetState extends State<DespachosWidget> {
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Inventario disponible caliente',
                ...
                child: Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewCalienteInventarioDisponibleCalienteResponse =
                          snapshot.data;
                      return Builder(
                        builder: (context) {
                          final inventarioCaliente = getJsonField(
                                (listViewCalienteInventarioDisponibleCalienteResponse
                                        ?.jsonBody ??
                                    ''),
                                r'''$''',
                              )?.toList() ??
                              [];
                          if (inventarioCaliente.isEmpty) {
                            return Center(
                              child: Container(
                          ...
                          return ListView.builder(
                            ...
                            itemCount: inventarioCaliente.length,
                            itemBuilder: (context, inventarioCalienteIndex) {
                              final inventarioCalienteItem =
                                  inventarioCaliente[inventarioCalienteIndex];
                              return Card(
