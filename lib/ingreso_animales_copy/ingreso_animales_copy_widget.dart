...
class IngresoAnimalesCopyWidget extends StatefulWidget {
  const IngresoAnimalesCopyWidget({Key key}) : super(key: key);

  @override
  _IngresoAnimalesCopyWidgetState createState() =>
      _IngresoAnimalesCopyWidgetState();
}

class _IngresoAnimalesCopyWidgetState extends State<IngresoAnimalesCopyWidget> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GestureDetector(
          ...
          child: Visibility(
            visible: (resultIngresos?.succeeded ?? true) ?? true,
            child: Column(
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                          'No se pudo realizar la consulta, revise la conectividad o intente más tarde. '),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
